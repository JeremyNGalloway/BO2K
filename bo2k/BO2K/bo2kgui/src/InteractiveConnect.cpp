...
// InteractiveConnect.cpp : implementation file
//
...
CInteractiveConnect::CInteractiveConnect(CWnd* pParent /*=NULL*/)
	: CDialog(CInteractiveConnect::IDD, pParent)
{
	//{{AFX_DATA_INIT(CInteractiveConnect)
	m_nEncryption = -1;
	m_nConnType = -1;
	m_nAuthHandler = -1;
	m_strSvrAddr = _T("");
...
void CInteractiveConnect::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CInteractiveConnect)
...
BEGIN_MESSAGE_MAP(CInteractiveConnect, CDialog)
	//{{AFX_MSG_MAP(CInteractiveConnect)
		// NOTE: the ClassWizard will add message map macros here
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CInteractiveConnect message handlers

void CInteractiveConnect::OnOK() 
{
	CComboBox *ccb;
...
BOOL CInteractiveConnect::OnInitDialog() 
{
	int i;
	CComboBox *ccb;
